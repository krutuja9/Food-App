...
const Navbar = () => {
    ...
    p-4 '>
            ...
            <div className='flex items-center' >
                ...
                text-[14px]  '>
                    <p className='bg-black text-white rounded-full p-2'>Delivary</p>
    ...
    'fixed top-[-100%] left-0 w-[300px] h-screen bg-white z-10 duration-100'}>
            <AiOutlineClose 
            onClick={() => setNav(!nav)}
            ...
            <nav>
                <ul>
                    <li className='text-xl py-4 flex hover:font-bold duration-200'>
                     ...
                     <li className='text-xl py-4 flex hover:font-bold duration-200'>
                         <BsFillSaveFill size={25} className='mr-4 '/>Best Ones </li>
                     <li className='text-xl py-4 flex hover:font-bold duration-200'>
